    ...
    return (
        <Layout>
            ...
            <ul>
                ...
                <li>Go to the <a href="https://github.com/freecodecampnorman/freecodecampnorman.github.io">Freecodecamp Norman github</a> and create a fork.
                <li>In your fork, create a new branch</li>
                <li>In your new branch, edit the src/data/fccUsers.json file, and add your user name to the bottom (compy and paste someone else's entry and then change the user name to yours)</li>
